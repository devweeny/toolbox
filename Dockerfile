...
ADD --chown=1000:1000  --chmod=0777 src/zsh-in-docker.sh .
...
ADD --chown=1000:1000 --chmod=0777 src/tasks.py .
ADD --chown=1000:1000 --chmod=0777 https://private-sw-downloads.s3.amazonaws.com/archfx_broker/preflight/broker_preflight.sh .

ADD --chown=1000:1000 --chmod=0777 src/test_net.sh .
